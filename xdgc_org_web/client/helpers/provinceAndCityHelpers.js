Template.registerHelper('parseProvince', function(code) {
    var prov = common_assets.cities.getProvinceByCode(code);
    return (prov && prov.name) || '';
});

Template.registerHelper('parseProvinceCity', function(pCode, cCode) {
    if (!(pCode && cCode)) { // avoid exception when code is null
        return '';
    }
    var city = common_assets.cities.getCityByCode(pCode, cCode);
